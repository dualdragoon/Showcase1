...
namespace Showcase
{
    ...
    class Gem
    {
        ...
        /// </summary>
        public Gem(Level level, Vector2 position, int r, int g, int b)
        {
            this.level = level;
        ...
        {
            spriteBatch.Draw(texture, Position, null, new Color(red, green, blue), 0.0f, origin, 1.0f, SpriteEffects.None, 0.0f);
        }
    }
}
