    ...
    class Level : IDisposable
    {
        ...
        private void LoadTiles(Stream fileStream)
        {
            ...
            using (StreamReader reader = new StreamReader(fileStream))
            {
                ...
                width = (StringCipher.Decrypt(line, "hello")).Length;
                while (line != null)
                {
                    lines.Add(line);
                    if ((StringCipher.Decrypt(line, "hello")).Length != width)
            ...
            // Loop for encrypted levels,
            List<string> decryptedLines = new List<string>();
            for (int i = 0; i < Height; i++)
            {
                decryptedLines.Add(StringCipher.Decrypt(lines.ElementAt<string>(i), "hello"));
            }
            ...
            for (int y = 0; y < Height; ++y)
            {
                ...
                {
                    // to load each tile.
                    char tileType = decryptedLines[y][x];
        ...
        private Tile LoadGemTile(int x, int y)
        {
            ...
            gems.Add(new Gem(this, new Vector2(position.X, position.Y), rnd.Next(0, 256), rnd.Next(0,256), rnd.Next(0, 256)));
